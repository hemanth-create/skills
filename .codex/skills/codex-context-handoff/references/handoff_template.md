...
Read `AGENTS.md` if present, then read `<this handoff path>`. Continue only from the confirmed context and Exact Next Steps; do not assume additional session history.
